export default function About() {
  return (
    <section id="about" className="py-20">
      ...
      <div className="space-y-4 text-text-secondary text-sm leading-relaxed max-w-4xl font-mono">
        <p>
        ...
        <div className="flex gap-3 pt-2">
          <a href="https://x.com/Mukherjee_ar" target="_blank" rel="noopener noreferrer" className="bg-dark-card border border-dark-border px-4 py-2 rounded text-xs hover:border-text-primary transition-colors flex items-center gap-2">
            <span>𝕏</span> Twitter
          </a>
          <a href="https://github.com/arpanmukherjee2006" target="_blank" rel="noopener noreferrer" className="bg-dark-card border border-dark-border px-4 py-2 rounded text-xs hover:border-text-primary transition-colors flex items-center gap-2">
            <span>⚡</span> GitHub
          </a>
          <a href="https://www.linkedin.com/in/arpan-mukherjee-3b12aa236/" target="_blank" rel="noopener noreferrer" className="bg-dark-card border border-dark-border px-4 py-2 rounded text-xs hover:border-text-primary transition-colors flex items-center gap-2">
            <span>💼</span> LinkedIn
          </a>
          <a href="https://www.instagram.com/berozgarengineerrr/" target="_blank" rel="noopener noreferrer" className="bg-dark-card border border-dark-border px-4 py-2 rounded text-xs hover:border-text-primary transition-colors flex items-center gap-2">
            <span>📷</span> Instagram
          </a>
        </div>
      </div>
